...
| T36 | Runtime = textures WebP référencées (zéro orphelin, zéro PNG dans `generated/`, staging hors `client/assets`). Gate : plafond de **santé** 2048 Mo / 8192 Ko/fichier, pas un objectif de design | Dérive orphelins/PNG encore un bug ; le poids n'est plus un critère de DA |
